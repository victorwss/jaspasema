package br.gov.sp.prefeitura.smit.cgtic.jaspasema.test;

import br.gov.sp.prefeitura.smit.cgtic.jaspasema.CookieParam;
import br.gov.sp.prefeitura.smit.cgtic.jaspasema.Get;
import br.gov.sp.prefeitura.smit.cgtic.jaspasema.HeaderJsonParam;
import br.gov.sp.prefeitura.smit.cgtic.jaspasema.HeaderParam;
import br.gov.sp.prefeitura.smit.cgtic.jaspasema.JsonBody;
import br.gov.sp.prefeitura.smit.cgtic.jaspasema.JsonBodyPlainProperty;
import br.gov.sp.prefeitura.smit.cgtic.jaspasema.JsonBodyProperty;
import br.gov.sp.prefeitura.smit.cgtic.jaspasema.Path;
import br.gov.sp.prefeitura.smit.cgtic.jaspasema.PlainBody;
import br.gov.sp.prefeitura.smit.cgtic.jaspasema.Post;
import br.gov.sp.prefeitura.smit.cgtic.jaspasema.ProducesJson;
import br.gov.sp.prefeitura.smit.cgtic.jaspasema.ProducesPlain;
import br.gov.sp.prefeitura.smit.cgtic.jaspasema.QueryPart;
import br.gov.sp.prefeitura.smit.cgtic.jaspasema.SessionParam;
import br.gov.sp.prefeitura.smit.cgtic.jaspasema.UriPart;
import br.gov.sp.prefeitura.smit.cgtic.jaspasema.test.ApiTester.Header;
